...
def generate_ancient_section(title: str, protocol_text: str, outline: dict, section_num: int,
    ...
    if section_num == 1:
        ...
        special = (
            ...
            "Write ONLY what this section's argument, evidence, and reframe specify above.\n"
            "Do not repeat or summarise any content from the approved sections already written.\n"
            "End with a question or tension that only the next section resolves."
        )
